...
<body>
    ...
    <div class="container">
        ...
        ResultSet rst = flight.get_Flights(depart_city,destination,type);
    %>  
    <div align="center"> <form action="payment.jsp" method="POST">
            <h3>Available Flights Based on Your Request <br> Choose one and Continue</h3>
        <table border="1">
            <thead>
                <tr>
                    <th>Flight Number</th>
                    ...
                    <tr>
                        ...
                        <td>Select <input type="radio" name="chooseFlight" value="<%= rst.getString("FLIGHTID")%>" /></td>
                        <td><input type="hidden" name="amount" value="<%= rst.getDouble("FLIGHTCOST")%>"</td>
